...
# === Path & filenames (Water) ===
folder = r"C:\Users\taras\OneDrive\Desktop\MA\Subtraction spectra\Water"

# If your files follow a pattern like Subtractionspectra_Water1..5, keep this:
basenames = [f"Subtractionspectra_Water{i}" for i in range(1, 6)]
basenames.append("20240626_Deposition_H2O_20K_sample1")
# If your files are named differently, just replace basenames with a list, e.g.:
# basenames = ["Water_1", "Water_2", "Water_3", "Water_4", "Water_5"]

ext_candidates = [".csv", ".txt", ".dat", ".dpt", ".asc"]

# === Plot x-window ===
x_left, x_right = 850, 650

# === Integration window ===
a, b = 800, 700  # adjust if needed
...
print(f"Water — Integration over {a}–{b} cm^-1 (relative to y=0):")
print("--------------------------------------------------------")
...
ax.set_title("Water spectra (same y-axis, no stacking) + integration area")
ax.invert_xaxis()
