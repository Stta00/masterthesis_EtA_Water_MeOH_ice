...
# === Path & filenames (Choline) ===
folder = r"C:\Users\taras\OneDrive\Desktop\MA\Subtraction spectra\Choline"

# Nur Subspectra 1–5 (kein initiales Spektrum!)
basenames = [f"Subtractionspectra_Choline{i}" for i in range(1, 6)]
# Falls deine Dateien anders heißen, ersetze basenames z.B. so:
# basenames = ["Choline_1", "Choline_2", "Choline_3", "Choline_4", "Choline_5"]

ext_candidates = [".csv", ".txt", ".dat", ".dpt", ".asc"]

# === Plot x-window ===
x_left, x_right = 950, 800

# === Integration window ===
a, b = 915, 875  # adjust if needed
...
print(f"Choline — Integration over {a}–{b} cm^-1 (relative to y=0):")
print("----------------------------------------------------------")
...
# y-limits ggf. anpassen
#ax.set_ylim(-0.001, 0.01)

ax.set_title("Choline subspectra 1–5 (same y-axis, no stacking) + integration area")
ax.invert_xaxis()
